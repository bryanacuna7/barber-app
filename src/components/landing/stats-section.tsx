    ...
    <section className="border-y border-zinc-200 bg-white py-20 dark:border-zinc-800 dark:bg-zinc-900">
      <div className="mx-auto max-w-7xl px-6">
          ...
          {stats.map((stat) => {
            ...
            return (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-zinc-50 p-8 transition-all dark:border-zinc-800 dark:bg-zinc-900/50"
              >
        ...
        <motion.div
          ...
          className="mt-16 flex flex-wrap items-center justify-center gap-8 text-sm text-zinc-500 dark:text-zinc-400"
        >
