...
| 4. Clientes      | ✅ DECIDED | **Demo Fusion: Dashboard + Canvas + Depth**    | 9.5/10         | Multi-view CRM (Dashboard/Cards/Table/Calendar), master-detail, search, sortable (48-65h) |
| 5. Servicios     | ✅ DECIDED | **Demo D: Simplified Hybrid (Sidebar)**        | 9.5/10         | Table view + insights sidebar (320px), CRUD-first, Lucide icons                           |
| 6. Barberos      | ✅ DECIDED | **Demo B: Visual CRM Canvas**                  | 8.5/10         | 4 view modes (Cards/Table/Leaderboard/Calendar), performance rings, flexible              |
| 7. Reportes      | ✅ DECIDED | **Demo Fusion: Intelligence Report (A+C)**     | 9.5/10         | Hero KPI + AI insights + professional tables + export                                     |
