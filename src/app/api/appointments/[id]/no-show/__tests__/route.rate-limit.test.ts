/**
 * RATE LIMITING TESTS - No-Show Appointment Endpoint
 *
 * Tests rate limiting implementation for marking appointments as no-show
 *
 * Priority: P1 (HIGH)
 */
...
describe('Rate Limiting Tests - PATCH /api/appointments/[id]/no-show', () => {
  ...
  describe('Rate Limit Success Cases', () => {
    it('should allow request when under rate limit', async () => {
      ...
      mockRequest = new NextRequest('http://localhost:3000/api/appointments/apt-123/no-show', {
        method: 'PATCH',
      })
  ...
  describe('Rate Limit Blocking Cases', () => {
    ...
    it('should not execute business logic when rate limited', async () => {
      ...
      // Database update should NOT be called when rate limited
