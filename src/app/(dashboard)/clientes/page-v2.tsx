  ...
  return (
    <ComponentErrorBoundary>
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <ComponentErrorBoundary
          fallbackTitle="Error en lista de clientes"
          fallbackDescription="No se pudo cargar la lista de clientes. Los filtros pueden estar causando el problema."
        >
          <div data-tour="clients-list" className="space-y-4">
            ...
            {/* NEW: All clients loaded in single query (no pagination) */}
            </div>
          </div>
        </ComponentErrorBoundary>
