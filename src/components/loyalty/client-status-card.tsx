...
export function ClientStatusCard({ status, program, businessName }: Props) {
  ...
  } else if (program.programType === 'visits' || program.programType === 'hybrid') {
  ...
  return (
    <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-primary/10 p-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold">Tu Programa de Lealtad</h3>
          </div>
        ...
        <Badge className={tierConfig.color} variant="outline">
        ...
        <div className="mt-6">
          <div className="flex items-end justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-lg font-semibold">{status.lifetimePoints.toLocaleString()}</p>
            </div>
          </div>
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 h-2.5 w-full overflow-hidden rounded-full bg-background/50">
              <div
      ...
      {(program.programType === 'visits' || program.programType === 'hybrid') && (
        <div className="mt-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-muted-foreground">Visitas Acumuladas</p>
      ...
      {/* Tier Progress */}
      {nextTier && (
        <div className="mt-6 rounded-lg border border-border/50 bg-background/50 p-3">
          <div className="flex items-center gap-2">
            <TrendingUp className="h-4 w-4 text-muted-foreground" />
            <p className="text-xs font-medium text-muted-foreground">Siguiente tier</p>
          </div>
        ...
        status.referralCode && (
          <div className="mt-6 space-y-3 border-t border-border/50 pt-6">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-medium">Refiere Amigos y Gana Recompensas</p>
            </div>
            ...
            <div className="rounded-lg border border-dashed border-border bg-background/50 p-3">
              ...
              <div className="mt-1 flex items-center justify-between">
                <p className="font-mono text-lg font-bold">{status.referralCode}</p>
                <button
                  onClick={() => {
