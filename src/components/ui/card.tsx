...
export function Card({
  ...
  const baseStyles = 'rounded-2xl p-4 sm:p-5 backdrop-blur-sm transition-colors duration-200'
  ...
  return (
    <MotionCard
      ...
      transition={animations.spring.card}
      {...props}
    >
      {children}
    </MotionCard>
...
export function StatCard({
  ...
  return (
    <Card hoverable className={cn('relative overflow-hidden', className)} {...props}>
      {icon && (
        <div className="mb-3 inline-flex p-3 rounded-xl bg-zinc-100 dark:bg-zinc-800">{icon}</div>
      )}
