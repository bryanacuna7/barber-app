        ...
        <div className="mt-8 grid items-center gap-16 lg:grid-cols-2">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              <Link
                href="/register"
                className="group inline-flex w-full cursor-pointer items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-4 text-base font-semibold text-white shadow-xl shadow-blue-500/20 transition-[box-shadow,filter] hover:from-blue-500 hover:to-purple-500 hover:shadow-2xl hover:shadow-blue-500/35 sm:w-auto"
              >
