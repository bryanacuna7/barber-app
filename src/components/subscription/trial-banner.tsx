...
export function TrialBanner({ variant = 'full' }: TrialBannerProps) {
  ...
  if (variant === 'compact' || (isBasicNonUrgent && !isUrgent)) {
    return (
      <Link
        href="/suscripcion"
        className="mb-2 lg:mb-5 flex w-full items-center justify-between gap-3 rounded-2xl border border-zinc-200/60 bg-white/70 px-3.5 py-3 shadow-[0_1px_2px_rgba(16,24,40,0.05),0_1px_3px_rgba(16,24,40,0.04)] dark:shadow-[0_10px_24px_rgba(0,0,0,0.28)] backdrop-blur-xl transition-colors hover:bg-zinc-50/90 dark:border-zinc-800/80 dark:bg-black/25 dark:hover:bg-black/35"
      >
