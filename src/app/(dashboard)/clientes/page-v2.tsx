          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            >
              <div className="-mx-4 px-4 lg:mx-0 lg:px-0">
                <div className="flex gap-3 overflow-x-auto pb-2 lg:pb-0 lg:grid lg:grid-cols-4 lg:gap-4 scrollbar-hide -mx-4 px-4 lg:mx-0 lg:px-0">
                  {/* Clientes Nuevos */}
                  <motion.div
                  ...
                  >
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-700/40 px-3 py-3 lg:px-4 lg:py-4 shadow-sm cursor-pointer">
                  ...
                  <motion.div
                    ...
                    transition={animations.spring.gentle}
                  >
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-700/40 px-3 py-3 lg:px-4 lg:py-4 shadow-sm cursor-pointer">
                      <div className="flex items-start justify-between mb-1.5 lg:mb-2">
                  ...
                  <motion.div
                    ...
                    transition={animations.spring.gentle}
                  >
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 border border-emerald-200 dark:border-emerald-700/40 px-3 py-3 lg:px-4 lg:py-4 shadow-sm cursor-pointer">
                      <div className="flex items-start justify-between mb-1.5 lg:mb-2">
                  ...
                  <motion.div
                    ...
                    transition={animations.spring.gentle}
                  >
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 border border-purple-200 dark:border-purple-700/40 px-3 py-3 lg:px-4 lg:py-4 shadow-sm cursor-pointer">
                      <div className="flex items-start justify-between mb-1.5 lg:mb-2">
