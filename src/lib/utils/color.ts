 ...
 *
 * Collection of functions for color manipulation, contrast calculation,
 * and WCAG compliance checks.
 */
...
/**
 * Returns white or black text color based on background color for best contrast
...
/**
 * Adjusts a brand color to meet WCAG AA contrast requirements (4.5:1)
 * @param brandColor The original brand color in hex format
 * @param onDarkBackground Whether the color will be displayed on a dark background
 * @returns An adjusted color that meets contrast requirements
 */
export function getReadableBrandColor(brandColor: string, onDarkBackground: boolean): string {
