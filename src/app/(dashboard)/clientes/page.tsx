...
export default function ClientesPageV2() {
  ...
  // Real client activity history (replaces mock data)
  ...
  const currentView = viewOptions.find((v) => v.mode === viewMode) ?? viewOptions[1]
        ...
        >
          <div className="relative overflow-x-hidden pb-4">
            ...
            <div className="relative z-10 space-y-4 sm:space-y-6">
              ...
              <Sheet open={segmentSheetOpen} onOpenChange={setSegmentSheetOpen}>
                <SheetContent side="bottom" centered>
                  <SheetClose onClose={() => setSegmentSheetOpen(false)} />
                  <SheetHeader>
                                    ...
                                    (() => {
                                      ...
                                      return allActivities.map((activity, index, arr) => (
                                        <ActivityItem
                                          ...
                                          amount={
                                            'amount' in activity ? activity.amount : undefined
                                          }
