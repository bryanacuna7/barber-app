...
import {
  Plus, Search, Phone, Mail, Calendar, Banknote, User,
  TrendingUp, Crown, Star, UserPlus, MessageCircle, History,
...
export default function ClientesPage() {
  ...
  const metrics = useMemo(() => {
    ...
    const avgValue = clients.length > 0
    ...
    // Cliente top
    const topClient = clients.reduce((top, c) =>
      Number(c.total_spent || 0) > Number(top?.total_spent || 0) ? c : top
    , clients[0])
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5 sm:gap-2">
                        ...
                        <span className={`hidden sm:inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium border ${segmentInfo.color}`}>
            ...
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium border mt-1 ${segmentConfig[getClientSegment(selectedClient)].color}`}>
