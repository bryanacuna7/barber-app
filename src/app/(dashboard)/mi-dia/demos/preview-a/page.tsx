...
/**
 * PREVIEW A: Bento Grid Command Center (Mock Data)
 *
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 mb-6">
          ...
          >
            ...
            <motion.div
              ...
              className="h-full bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl border border-white/20 p-8 relative overflow-hidden min-h-[400px]"
            >
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-full">
              ...
              <span className="text-xs text-white/60">En vivo (demo)</span>
            </div>
          </div>
