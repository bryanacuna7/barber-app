/**
 * RATE LIMITING TESTS - Mi Día Status Update Endpoints
 *
 * Tests rate limiting implementation for appointment status updates
 *
 * Priority: P1 (HIGH)
 */
    ...
    mockSupabase.from.mockReturnValue({
      ...
      single: vi.fn().mockResolvedValue({
        data: {
          ...
          barber: { id: 'barber-123', email: 'barber@test.com' },
        },
        error: null,
      }),
