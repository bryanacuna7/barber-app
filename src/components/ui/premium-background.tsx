export function PremiumBackground() {
  return (
    <div className="fixed inset-0 -z-50 overflow-hidden pointer-events-none">
      {/* Base Gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-zinc-50 via-white to-zinc-50 dark:from-zinc-950 dark:via-zinc-950 dark:to-zinc-950" />

      {/* Subtle ambient mesh — CSS animations for zero JS cost */}
      <div className="absolute inset-0 opacity-[0.07] dark:opacity-0">
        <div
